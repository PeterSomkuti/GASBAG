...
#       calendar. The Gregorian calendar took effect after 10-15-1582 and
#       the dates 10-05 through 10-14-1582 never occurred. Python datetime
#       objects will produce incorrect time deltas if one date is from
#       before 10-15-1582.
